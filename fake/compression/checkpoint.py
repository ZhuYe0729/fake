...
def checkpoint_csv_fields(metadata: dict[str, Any], checkpoint_path: str | None, method: str) -> dict[str, object]:
    return {
        ...
        "int4_group_size": metadata.get("int4_group_size", ""),
        "int4_scale_precision": metadata.get("int4_scale_precision", ""),
        "sparsegpt_block_size": metadata.get("sparsegpt_block_size", ""),
        "sparsegpt_percdamp": metadata.get("sparsegpt_percdamp", ""),
        "hessian_algo": metadata.get("hessian_algo", ""),
