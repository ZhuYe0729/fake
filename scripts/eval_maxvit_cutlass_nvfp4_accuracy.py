...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate MaxViT CUTLASS dense NVFP4 on ImageNet val zip dataset.")
...
def main() -> None:
    ...
    output = args.output or f"artifacts/results/{variant_info.result_key}_cutlass_nvfp4/accuracy.csv"
    runtime_load = None
    ...
    print(
        "maxvit cutlass nvfp4 accuracy done: "
