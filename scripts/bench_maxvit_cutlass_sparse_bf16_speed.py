...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark MaxViT with CUTLASS sparse BF16 Linear kernels.")
...
def main() -> None:
    ...
    output = args.output or f"artifacts/results/{variant_info.result_key}_cutlass_sparse_bf16/speed.csv"
    runtime_load = None
    ...
    print(
        "maxvit cutlass sparse bf16 speed done: "
