...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark MaxViT with CUTLASS sparse NVFP4 Linear kernels.")
...
def main() -> None:
    ...
    output = args.output or f"artifacts/results/{variant_info.result_key}_cutlass_sparse_nvfp4/speed.csv"
    runtime_load = None
    ...
    print(
        "maxvit cutlass sparse nvfp4 speed done: "
