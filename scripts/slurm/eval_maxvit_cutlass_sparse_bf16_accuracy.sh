#!/bin/bash
#SBATCH --job-name=maxvit_sparse_bf16_acc
#SBATCH --partition=gpu_5090
#SBATCH --gpus=1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=out/maxvit_sparse_bf16_acc_%j.out
#SBATCH --error=err/maxvit_sparse_bf16_acc_%j.err
...
OUTPUT="${OUTPUT:-artifacts/results/maxvit_${MAXVIT_VARIANT}_cutlass_sparse_bf16/accuracy.csv}"
...
PYTHONPATH=. python scripts/eval_maxvit_cutlass_sparse_bf16_accuracy.py \
