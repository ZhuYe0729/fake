#!/bin/bash
#SBATCH --job-name=dinov3_4over6_acc
#SBATCH --partition=gpu_5090
#SBATCH --gpus=1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=out/dinov3_4over6_acc_%j.out
#SBATCH --error=err/dinov3_4over6_acc_%j.err
...
PYTHONPATH=. python scripts/eval_dinov3_vit7b16_four_over_six_accuracy.py "${ARGS[@]}"
