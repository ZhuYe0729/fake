#!/bin/bash
#SBATCH --job-name=maxvit_sparse_nvfp4
#SBATCH --partition=gpu_5090
#SBATCH --gpus=1
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=out/maxvit_sparse_nvfp4_%j.out
#SBATCH --error=err/maxvit_sparse_nvfp4_%j.err
...
NO_PRUNE="${NO_PRUNE:-0}"
OUTPUT="${OUTPUT:-artifacts/results/maxvit_${MAXVIT_VARIANT}_cutlass_sparse_nvfp4/speed.csv}"
...
PYTHONPATH=. python scripts/bench_maxvit_cutlass_sparse_nvfp4_speed.py \
