...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark DINOv3 ViT-7B/16 CUTLASS sparse BF16 classifier forward speed.")
    ...
    parser.add_argument("--output", default="artifacts/results/dinov3_vit7b16_cutlass_sparse_bf16/speed.csv")
...
def main() -> None:
    ...
    print(
        "dinov3 cutlass sparse bf16 speed done: "
