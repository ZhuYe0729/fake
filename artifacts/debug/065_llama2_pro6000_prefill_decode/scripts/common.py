#!/usr/bin/env python3
"""Shared paths, frozen protocol and subprocess helpers for experiment 065."""
...
CANONICAL_SOURCE = BUNDLE.parent / "064_llama2_pro6000_prefill_only/runs/experiment/canonical/prepared"
