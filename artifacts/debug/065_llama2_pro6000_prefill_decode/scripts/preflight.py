#!/usr/bin/env python3
"""Fail-fast environment and dependency audit for the isolated 065 run."""
...
from common import (BERTSCORE_MODEL, BUNDLE, CANONICAL_SOURCE, COSPAQ_PYTHON, CUTLASS,
...
def main() -> None:
    ...
    required = {
        ...
        "canonical_sparse_bf16": CANONICAL_SOURCE / "sparse_bf16/model.pt",
        "canonical_sparse_nvfp4": CANONICAL_SOURCE / "sparse_nvfp4/model.pt",
    ...
    if model_config.get("model_type") != "llama" or model_config.get("num_hidden_layers") != 32:
        errors.append("model is not the expected 32-layer Llama")
    runtime_hits = {}
