#!/usr/bin/env python3
"""Export a Llama checkpoint for artifact-local phase_hetero_mytest."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--prune", action="store_true",
                        help="Forbidden in 064; retained only for fail-fast compatibility.")
...
def main() -> None:
    ...
    if args.prune:
        raise RuntimeError("064 forbids direct pruning; provide canonical sparse states")
