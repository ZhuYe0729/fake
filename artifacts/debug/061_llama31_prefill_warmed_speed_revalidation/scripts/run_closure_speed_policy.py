#!/usr/bin/env python3
"""Measure one newly solved policy with the fixed warmed E2E protocol."""
...
from scenario import (EXP, MODEL, REUSE_DENSE_EXPORTER, CANONICAL, BENCH, VLLM_PYTHON,
...
def main() -> None:
    ...
    output = EXP / "pareto/closure/speed" / f"{args.policy}.json"
