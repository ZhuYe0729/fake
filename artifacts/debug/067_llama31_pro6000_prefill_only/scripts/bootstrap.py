...
EXPECTED_SAMPLE_SHA256 = "c201cbe60ff361f51956f1385ebb9b2e09250d02fc53b1c88c0e80f7e8293e18"
...
def main() -> None:
    ...
    if EXPECTED_SAMPLE_SHA256 is not None and actual_hash != EXPECTED_SAMPLE_SHA256:
    ...
    write_json(RUN / "bootstrap_provenance.json", {
        ...
        "sample_seed": 86, "sample_tokens": 2049,
