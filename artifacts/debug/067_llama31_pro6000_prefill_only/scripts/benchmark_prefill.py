#!/usr/bin/env python3
"""One Llama3.1 prefill-only benchmark process with in-engine warmup/repeats."""
...
def main() -> None:
    ...
    for index in range(total):
        ...
        output_json.write_text(json.dumps({"checkpoint": str(args.checkpoint), "batch": args.batch,
            ...
            "chunked_prefill_guard": "067_process_local_vllm_0.11_compat", "phase_trace": str(trace_path),
