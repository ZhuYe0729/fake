...
EXP = ROOT / "artifacts/debug/055_llama2_prefill_decode_canonical_pareto/llama2_7b_chat/task_quality"
BASE = ROOT / "artifacts/exports/vllm/baselines/llama2-7b-chat"
...
def main() -> None:
    ...
    speed = rows(ROOT / "artifacts/debug/035_llama2_prefill_decode_e2e_speed_model/baseline_speed_util085/summary.csv")
    ...
    for dataset, (_, ylabel) in METRICS.items():
        ...
        ax.set_title(f"Llama2-7B prefill-decode: speed vs {ylabel}")
