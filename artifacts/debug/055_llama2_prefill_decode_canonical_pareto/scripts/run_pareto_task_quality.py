...
def main() -> None:
    ...
    parser.add_argument("--policies", default="point_001,point_003,point_004,point_005,point_009")
    ...
    base = ROOT / "llama2_7b_chat/task_quality"
    ...
    def run(task: tuple[str, str, int, int]) -> tuple[str, str, int, int]:
        ...
        checkpoint = base / "checkpoints" / policy
