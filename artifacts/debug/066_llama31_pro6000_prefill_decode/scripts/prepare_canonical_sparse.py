#!/usr/bin/env python3
"""Prepare the two Pro 6000 canonical Llama3.1 sparse states."""
...
MODEL_PATH = Path(os.environ.get("COSPAQ_MODEL_PATH", "/root/data/models/Meta-Llama-3.1-8B-Instruct"))
...
def prepare_one_method(args: argparse.Namespace, method: str, *, device: str) -> None:
    ...
    payload = {
        ...
        "metadata": {
            "checkpoint_format": "llama31_instruct_pro6000_canonical_sparse_state_v1",
            "model_key": MODEL_KEY,
