...
def write_run_config(args: argparse.Namespace, output_dir: Path,
    ...
    from common import TASK_TEMPLATE
    config = {
        ...
        "prompt_protocol": "PMPD Claude-style raw text; no model chat template",
    }
...
def main() -> None:
    args = parse_args()
    from common import CUTLASS, TASK_TEMPLATE, VLLM_ROOT
    ...
    if TASK_TEMPLATE != "legacy":
        raise ValueError(
            "066 freezes COSPAQ_TASK_TEMPLATE=legacy; native chat templating is not part of this run")
