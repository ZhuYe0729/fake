...
from common import MODEL, RESULTS, RUN, TASK_TEMPLATE, write_json
...
def main() -> None:
    ...
    write_json(RESULTS / "source_summary.json", {
        "model": str(MODEL), "scenario": "prefill_decode",
        "task_template": TASK_TEMPLATE,
        "speed_source": "exclusive 1+5 measured vLLM E2E median",
