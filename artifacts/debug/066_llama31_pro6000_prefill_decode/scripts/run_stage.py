#!/usr/bin/env python3
"""Single restartable entry point for every 066 experiment stage."""
...
def main() -> None:
    ...
    if args.stage == "preflight":
        ...
        run(COSPAQ_PYTHON, "prepare_canonical_sparse.py", "--methods", "sparse_bf16",
            "--gpu", "0", "--skip-existing", env=env)
        run(COSPAQ_PYTHON, "prepare_canonical_sparse.py", "--methods", "sparse_nvfp4",
            "--gpu", "0", "--sparse-nvfp4-prequant-only", "--skip-existing", env=env)
