...
REPO_ROOT = Path(os.environ.get("COSPAQ_REPO_ROOT", Path(__file__).resolve().parents[4])).resolve()
...
os.environ.setdefault("HF_HOME", "/root/data/huggingface")
os.environ.setdefault("HF_DATASETS_CACHE", "/root/data/huggingface/datasets")
os.environ.setdefault("TRANSFORMERS_CACHE", "/root/data/huggingface/transformers")
...
MODELS = {
    "llama2-7b": {
        "label": "Llama-2-7B",
        "path": "/root/data/models/Llama-2-7b-chat-hf",
        "family": "llama",
        "loader": "causal_lm",
    ...
    "llama31-8b": {
        ...
        "path": "/root/data/models/Meta-Llama-3.1-8B-Instruct",
        "family": "llama",
        "loader": "causal_lm",
        "trust_remote_code": False,
    },
    "qwen35-9b": {
        "label": "Qwen3.5-9B",
        "path": "/root/data/models/Qwen3.5-9B",
        "family": "qwen3_5",
        "loader": "causal_lm",
        "trust_remote_code": True,
    },
}
DEFAULT_MODEL_KEY = "llama31-8b"
METHODS = (
    "dense_bf16",
    "sparse_bf16",
    "dense_nvfp4",
