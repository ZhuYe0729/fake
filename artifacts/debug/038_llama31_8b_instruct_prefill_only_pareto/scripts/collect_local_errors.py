#!/usr/bin/env python3
"""Collect fresh Llama3 prefill local output-relative-MSE features by bucket/type."""
...
def main():
    ...
    out = ROOT / 'local_errors' / f'prefill_{a.method}.csv'; out.parent.mkdir(parents=True, exist_ok=True)
