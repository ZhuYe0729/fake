...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--points", default="all", help="'all' or a positive number of representative points.")
...
def main() -> None:
    ...
    indices = list(range(len(rows))) if args.points == "all" else representative_indices(len(rows), int(args.points))
    selected = []
