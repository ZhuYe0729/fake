...
- dense_nvfp4 vs nll_delta_recomputed: pearson=0.778209680650819, spearman=0.7645256592625013, rows=38
- dense_nvfp4 vs arc_acc_delta_vs_dense: pearson=-0.005717468581905855, spearman=0.19516044564916551, rows=38
- dense_nvfp4 vs arc_acc_norm: pearson=-0.42064387885672727, spearman=-0.39977985831921564, rows=38
- sparse_bf16 vs nll_delta_recomputed: pearson=0.9574225450748619, spearman=0.9113688587372796, rows=38
- sparse_bf16 vs arc_acc_delta_vs_dense: pearson=-0.5742667063868873, spearman=-0.10187230517589453, rows=38
- sparse_bf16 vs arc_acc_norm: pearson=-0.8586413341614487, spearman=-0.5523153005729725, rows=38
- sparse_nvfp4 vs nll_delta_recomputed: pearson=0.9233793974433534, spearman=0.9203413940256043, rows=38
- sparse_nvfp4 vs arc_acc_delta_vs_dense: pearson=-0.8989079287962235, spearman=-0.5216886315816287, rows=38
- sparse_nvfp4 vs arc_acc_norm: pearson=-0.8916920510300962, spearman=-0.556955347564935, rows=38
