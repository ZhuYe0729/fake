...
| prefill-decode (B=16, S=2048, O=80) | uniform | dense_bf16 | baseline | 3432.16 | 1.000 | — | 19.487 | 13.784 | 10.680 | 0.000 | evaluated | fresh continuous closure |
| prefill-decode (B=16, S=2048, O=80) | uniform | dense_nvfp4 |  | 3242.68 | 1.058 | — | 16.345 | 8.203 | 10.312 | 2.882 | evaluated | fresh continuous closure |
| prefill-decode (B=16, S=2048, O=80) | uniform | marlin_nvfp4 |  | 3134.70 | 1.158 | — | 16.108 | 8.805 | 10.403 | 2.882 | evaluated | frozen legacy runner* |
| prefill-decode (B=16, S=2048, O=80) | uniform | sparse_bf16 |  | 2926.34 | 1.173 | — | 12.834 | 4.049 | 3.276 | 55.306 | evaluated | fresh continuous closure |
| prefill-decode (B=16, S=2048, O=80) | uniform | sparse_nvfp4 |  | 4589.68 | 0.791 | — | 0.804 | 0.126 | 0.014 | 113.600 | evaluated | frozen legacy runner* |
| prefill-decode (B=16, S=2048, O=80) | ours | point_000 | identity / dense reference | 3432.16 | 1.000 | — | 19.487 | 13.784 | 10.680 | 0.000 | same policy as dense BF16 | fresh continuous closure |
| prefill-decode (B=16, S=2048, O=80) | ours | point_002 | recommended: high-quality | 3132.48 | 1.096 | — | 20.274 | 13.473 | 10.586 | 0.387 | evaluated on all three tasks | fresh continuous closure |
| prefill-decode (B=16, S=2048, O=80) | ours | point_004 | recommended: primary balanced | 2708.39 | 1.267 | — | 18.747 | 13.266 | 10.654 | 0.543 | evaluated on all three tasks | fresh continuous closure |
| prefill-decode (B=16, S=2048, O=80) | ours | point_006 | recommended: fast task-validated | 2312.23 | 1.484 | — | 16.675 | 11.122 | 10.582 | 1.638 | evaluated on all three tasks | fresh continuous closure |
| prefill-decode (B=16, S=2048, O=80) | ours | point_008 | recommended: high-speed task-validated | 2165.02 | 1.585 | — | 16.274 | 8.957 | 10.546 | 2.821 | evaluated on all three tasks | fresh continuous closure |
| prefill-decode (B=16, S=2048, O=80) | ours | point_009_max_speed | recommended: max-speed endpoint | 2028.53 | 1.692 | — | 16.840 | 9.085 | 10.570 | 2.882 | pre-existing max-speed task run | fresh continuous closure |
